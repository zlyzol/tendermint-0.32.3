...
See the [open issues](https://github.com/zlyzol/tendermint-0.32.3/issues) for things we need help with!
...
`$GOPATH/src/github.com/zlyzol/tendermint-0.32.3`, and do all the work there.

For instance, to create a fork and work on a branch of it, I would:

- Create the fork on github, using the fork button.
- Go to the original repo checked out locally (i.e. `$GOPATH/src/github.com/zlyzol/tendermint-0.32.3`)
...
- create a development branch either on github.com/zlyzol/tendermint-0.32.3, or your fork (using `git remote add origin`)
