...
// Examples
//
// - [Tendermint](https://github.com/zlyzol/tendermint-0.32.3/blob/master/rpc/core/routes.go)
// - [tm-monitor](https://github.com/zlyzol/tendermint-0.32.3/blob/master/tools/tm-monitor/rpc.go)
package rpc
