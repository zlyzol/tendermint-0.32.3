...
is to run [this script](https://github.com/zlyzol/tendermint-0.32.3/blob/master/scripts/install/install_tendermint_ubuntu.sh) on
a fresh Ubuntu instance,
or [this script](https://github.com/zlyzol/tendermint-0.32.3/blob/master/scripts/install/install_tendermint_bsd.sh)
...
To download pre-built binaries, see the [releases page](https://github.com/zlyzol/tendermint-0.32.3/releases).

## From Source

You'll need `go` [installed](https://golang.org/doc/install) and the required
[environment variables set](https://github.com/zlyzol/tendermint-0.32.3/wiki/Setting-GOPATH)
