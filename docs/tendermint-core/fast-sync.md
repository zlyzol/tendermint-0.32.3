...
method](https://github.com/zlyzol/tendermint-0.32.3/blob/b467515719e686e4678e6da4e102f32a491b85a0/blockchain/pool.go#L128).

If we're lagging sufficiently, we should go back to fast syncing, but
this is an [open issue](https://github.com/zlyzol/tendermint-0.32.3/issues/129).
