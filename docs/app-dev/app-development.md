...
application](https://github.com/zlyzol/tendermint-0.32.3/blob/master/abci/example/kvstore/kvstore.go),
which is a part of the abci repo. [persistent_kvstore
application](https://github.com/zlyzol/tendermint-0.32.3/blob/master/abci/example/kvstore/persistent_kvstore.go)
...
docs](https://godoc.org/github.com/zlyzol/tendermint-0.32.3/lite#hdr-How_We_Track_Validators)
