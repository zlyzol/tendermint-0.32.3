...
[here](https://github.com/zlyzol/tendermint-0.32.3/wiki/Setting-GOPATH) for
more info.

Then run

```
go get github.com/zlyzol/tendermint-0.32.3
...
human-readable](https://github.com/zlyzol/tendermint-0.32.3/issues/1794).
