...
script](https://github.com/zlyzol/tendermint-0.32.3/blob/master/networks/remote/integration.sh)
...
```
cd $GOPATH/src/github.com/zlyzol/tendermint-0.32.3/networks/remote/terraform
```
...
directory](https://github.com/zlyzol/tendermint-0.32.3/tree/master/networks/remote/ansible)
run ansible roles to configure the sentry node architecture. You must
switch to this directory to run ansible
(`cd $GOPATH/src/github.com/zlyzol/tendermint-0.32.3/networks/remote/ansible`).
...
```
ansible-playbook -i inventory/digital_ocean.py -l sentrynet config.yml -e BINARY=$GOPATH/src/github.com/zlyzol/tendermint-0.32.3/build/tendermint -e CONFIGDIR=$GOPATH/src/github.com/zlyzol/tendermint-0.32.3/networks/remote/ansible/mytestnet
```
