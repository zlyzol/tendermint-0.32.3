...
- To _prevote_ or _precommit_ something means to broadcast a [prevote
  vote](https://godoc.org/github.com/zlyzol/tendermint-0.32.3/types#Vote)
  or [first precommit
  vote](https://godoc.org/github.com/zlyzol/tendermint-0.32.3/types#FirstPrecommit)
  for something.
...
- Nodes gossip to nodes lagging in blockchain height with block
  [commits](https://godoc.org/github.com/zlyzol/tendermint-0.32.3/types#Commit)
  for older blocks.
...
voting power (see
[implementation](https://github.com/zlyzol/tendermint-0.32.3/blob/master/types/validator_set.go)).
