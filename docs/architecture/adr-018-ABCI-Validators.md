...
As noted in ADR-009[https://github.com/zlyzol/tendermint-0.32.3/blob/master/docs/architecture/adr-009-ABCI-design.md],
...
- [Latest ABCI Spec](https://github.com/zlyzol/tendermint-0.32.3/blob/v0.22.8/docs/app-dev/abci-spec.md)
- [ADR-009](https://github.com/zlyzol/tendermint-0.32.3/blob/v0.22.8/docs/architecture/adr-009-ABCI-design.md)
- [Issue #1712 - Don't send PubKey in
  RequestBeginBlock](https://github.com/zlyzol/tendermint-0.32.3/issues/1712)
