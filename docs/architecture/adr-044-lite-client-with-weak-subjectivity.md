...
[lite](https://github.com/zlyzol/tendermint-0.32.3/tree/master/lite) package. This
...
rules](https://github.com/zlyzol/tendermint-0.32.3/blob/master/docs/spec/blockchain/blockchain.md#validation)
to each block.
...
[here](https://github.com/zlyzol/tendermint-0.32.3/blob/master/docs/spec/consensus/light-client.md).
