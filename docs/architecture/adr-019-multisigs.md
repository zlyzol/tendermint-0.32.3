...
This ADR assumes that [replacing crypto.Signature with []bytes](https://github.com/zlyzol/tendermint-0.32.3/issues/1957) has been accepted.
...
Evidence for this is outlined in [this issue](https://github.com/zlyzol/tendermint-0.32.3/issues/2077).
