...
// See https://github.com/zlyzol/tendermint-0.32.3/blob/0.1/docs/sts-final.pdf for
...
// (TODO(ismail): see also https://github.com/zlyzol/tendermint-0.32.3/issues/3010)
...
func computeDHSecret(remPubKey, locPrivKey *[32]byte) (shrKey *[32]byte, err error) {
	...
	// related to: https://github.com/zlyzol/tendermint-0.32.3/issues/3010
	zero := new([32]byte)
...
func incrNonce(nonce *[aeadNonceSize]byte) {
	...
	if counter == math.MaxUint64 {
		...
		// See https://github.com/zlyzol/tendermint-0.32.3/issues/3531
