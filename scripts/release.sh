...
# today=$(date +"%B-%d-%Y")
# ghr -b "https://github.com/zlyzol/tendermint-0.32.3/blob/master/CHANGELOG.md#${VERSION//.}-${today,}" "v$VERSION" "$DIR/build/dist"
...
echo "==> TODO: update DOCKER/README.md (latest Dockerfile's hash is $(git rev-parse HEAD)) and copy it's content to https://store.docker.com/community/images/zlyzol/tendermint-0.32.3"
